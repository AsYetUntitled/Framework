...
*/
private _BIS_Functions = SPY_SETTINGS(getArray,"BIS_Functions");
private _BIS_UI_Functions = SPY_SETTINGS(getArray,"BIS_UI_Functions");
private _LIFE_Functions = SPY_SETTINGS(getArray,"LIFE_Functions");
private _SERVER_Functions = SPY_SETTINGS(getArray,"SERVER_Functions");
private _SOCK_Functions = SPY_SETTINGS(getArray,"SOCK_Functions");
private _DB_Functions = SPY_SETTINGS(getArray,"DB_Functions");
private _SPY_Functions = SPY_SETTINGS(getArray,"SPY_Functions");
private _allowedVariables = SPY_SETTINGS(getArray,"allowedVariables");
private _allowedVariables_UI = SPY_SETTINGS(getArray,"allowedVariables_UI");
private _profileCount = count allVariables profileNameSpace;
