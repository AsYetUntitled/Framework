...
/* System Settings */
    ...
    med_extendedSkins = false; //Enable or disable med skins by level. Before enabling, you must add all the FIVE files to textures folder. same as cop_extendedSkins
