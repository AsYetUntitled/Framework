...
switch (_state) do {
	...
	case 2: {
		if(missionNamespace getVariable LICENSE_VARNAME("driver","civ") OR missionNamespace getVariable LICENSE_VARNAME("pilot","civ") OR missionNamespace getVariable LICENSE_VARNAME("trucking","civ") OR missionNamespace getVariable LICENSE_VARNAME("boat","civ")) then {
