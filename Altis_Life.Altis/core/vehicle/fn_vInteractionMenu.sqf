...
if((life_inv_toolkit >= 1) && {alive life_vInact_curTarget} && {([life_vInact_curTarget] call life_fnc_getDamage)}) then {_Btn1 ctrlEnable true;} else {_Btn1 ctrlEnable false;};
