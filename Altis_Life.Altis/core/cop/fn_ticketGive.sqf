...
[[0,format["%1 gave a ticket of $%2 to %3",player getVariable["realname",player getVariable["realname",name player]],[(parseNumber _val)] call life_fnc_numberText,life_ticket_unit getVariable["realname",name life_ticket_unit]]],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
