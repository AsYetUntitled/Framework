...
*/
private["_uid","_name","_side","_money","_bank","_licenses","_misc","_query","_result","_array"];
...
switch (_side) do
{
	case west:
	{
		...
		_query = format["UPDATE players SET name='%1', money='%2', bank='%3', cop_gear='%4', cop_licenses='%5' WHERE playerid='%6'",_name,_money,_bank,_misc,_licenses,_uid];
	};
	...
	case civilian:
	{
		...
		_query = format["UPDATE players SET name='%1', money='%2', bank='%3', civ_licenses='%4' WHERE playerid='%5'",
		_name,_money,_bank,_licenses,_uid];
	};
};
