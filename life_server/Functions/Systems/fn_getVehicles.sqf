...
_query = format ["SELECT id, side, classname, type, pid, alive, active, plate, color, shop FROM vehicles WHERE pid='%1' AND alive='1' AND active='0' AND side='%2' AND type='%3'",_pid,_side,_type];
