...
if ((_vInfo select 1) isEqualTo "civ" && (_vInfo select 2) isEqualTo "B_Heli_Light_01_stripped_F") then {
    [_vehicle,"reb_hummingbird",true] remoteExecCall ["life_fnc_vehicleAnimate",_unit];
};
