...
switch (_mode) do {
    case 0: {
        ...
        [format ["UPDATE gangs SET bank='%1', maxmembers='%2', owner='%3' WHERE id='%4'", [(_group getVariable ["gang_bank",0])] call DB_fnc_numberSafe, _group getVariable ["gang_maxMembers",8], _owner, _groupID],1] call DB_fnc_asyncCall;
    };
