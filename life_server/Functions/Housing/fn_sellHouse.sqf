...
if (_houseID isEqualTo -1) then {
    [format ["UPDATE houses SET owned='0', pos='[]' WHERE pid='%1' AND pos='%2' AND owned='1'", (_house getVariable "house_owner") select 0, getPosATL _house], 1] call DB_fnc_asyncCall;
} else {
